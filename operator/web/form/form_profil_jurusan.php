...
cek_url($url2, $proses, $_GET['act'], 'jurusan', 'seo = "' . @$_GET['seo'] . '"');
cek_url($url2, $proses, $_GET['act'], 'profil_jurusan', 'id_profil = "' . @$_GET['id'] . '"');
$p = $proses->tampil_data_saja('*', 'jurusan', '1=1 AND seo = "' . @$_GET['seo'] . '"');
?>
<!DOCTYPE html>
                    ...
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">
                                <?= ucfirst($_GET['act']) . ' ' . str_replace('-', ' ', $p['nama_jurusan']); ?>
                            </h4>
                        </div>
    ...
    $(document).on('submit', '#form', function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                setTimeout(function() {
                    window.location = "<?= $url2 ?>profil/jurusan/<?= $p['seo']; ?>";
                }, 2000)
            },
