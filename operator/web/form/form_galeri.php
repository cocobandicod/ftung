...
cek_url($url2, $proses, $_GET['act'], 'galeri', 'id = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'galeri', 'id = ' . $_GET['id'] . '');
                                        ...
                                        if (empty($row['file'])) {
                                            ...
                                            <img src="' . $url . 'assets/img/galeri/thumb_' . $row['file'] . '" class="img-thumbnail">
                                            <div class="form-text text-muted"><a href="#" id="del" data-id="' . $row['id'] . '" data-file="' . $row['file'] . '" data-nama="' . $row['ket'] . '" data-act="image"><i class="ph-trash me-1"></i>Hapus Gambar</a></div>
                                            </div>';
                                            $required = '';
                                            $ket = '<br>*Kosongkan jika tidak merubah gambar';
                                        }
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="ket" class="form-control" value="<?= @$row['ket']; ?>" required>
                                        </div>
                                        <div class="revdiv">
                                            <?= $image; ?>
                                            <div class="mb-2">
