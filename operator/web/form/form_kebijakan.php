...
cek_url($url2, $proses, $_GET['act'], 'kebijakan_peraturan', 'id_kebijakan = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'kebijakan_peraturan', 'id_kebijakan = ' . $_GET['id'] . '');
                                        echo '<input type="hidden" name="id" value="' . $row['id_kebijakan'] . '">';
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            <label class="form-label">Kebijakan/Peraturan</label>
                                            <textarea name="kebijakan_peraturan" class="form-control" required><?= @$row['kebijakan_peraturan']; ?></textarea>
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Kategori</label>
                                            <?= kebijakan('ket', @$row['ket']); ?>
                                        </div>
                                        <div class="revdiv">
                                            <?= $files; ?>
                                            <div class="mb-2">
                                                ...
                                                <div class="form-text text-muted">*Accepted formats: pdf Max file size 10Mb<?= $ket; ?></div>
                                            </div>
                                        </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                new Noty({
                    ...
                    setTimeout(function() {
                        window.location = "<?= $url2 ?>kebijakan";
                    }, 2000)
                );
            },
