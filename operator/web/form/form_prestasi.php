...
cek_url($url2, $proses, $_GET['act'], 'prestasi', 'id_jurusan = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'prestasi', 'id_jurusan = ' . $_GET['id'] . '');
