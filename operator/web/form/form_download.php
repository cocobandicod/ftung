...
cek_url($url2, $proses, $_GET['act'], 'download', 'id_download = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                    ...
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">
                                <?= ucfirst($_GET['act']) . ' ' . ucwords(str_replace('-', ' ', $_GET['kat'])); ?>
                            </h4>
                        </div>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'download', 'id_download = ' . $_GET['id'] . '');
                                        echo '<input type="hidden" name="id" value="' . $row['id_download'] . '">';
                                        ...
                                        echo '<input type="hidden" name="kategori" value="' . $_GET['kat'] . '">';
                                        $files = '';
                                        $ket = '';
                                        $required = 'required';
                                    }
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="nama_file" class="form-control" value="<?= @$row['nama_file']; ?>" required>
                                        </div>
                                        <div class="revdiv">
                                            <?= $files; ?>
                                            <div class="mb-2">
        ...
        $.ajax({
            ...
            success: function(data) {
                new Noty({
                    ...
                    setTimeout(function() {
                        window.location = "<?= $url2 ?>laboratorium/download/<?= $_GET['kat']; ?>";
                    }, 2000)
                );
            },
