...
cek_url($url2, $proses, $_GET['act'], 'agenda', 'id_agenda = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="post" id="form" class="form">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'agenda', 'id_agenda = ' . $_GET['id'] . '');
                                        echo '<input type="hidden" name="id_agenda" value="' . $row['id_agenda'] . '">';
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <textarea name="nama" class="form-control" required><?= @$row['nama']; ?></textarea>
                                        </div>
                                        <div class="mb-2">
