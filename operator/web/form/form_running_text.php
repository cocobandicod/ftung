...
cek_url($url2, $proses, $_GET['act'], 'running_text', 'id = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="post" id="form" class="form">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'running_text', 'id = ' . $_GET['id'] . '');
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        <div class="mb-2">
                                            ...
                                            <textarea name="text" class="form-control" required><?= @$row['text']; ?></textarea>
                                        </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                new Noty({
                    ...
                    setTimeout(function() {
                        window.location = "<?= $url2 ?>running/text";
                    }, 2000)
                );
            },
