...
cek_url($url2, $proses, $_GET['act'], 'berita', 'id = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                            ...
                            <div class="row">
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    ...
                                    if ($_GET['act'] == 'edit') {
                                        ...
                                        $tanggal = ubah_tgl_edit2($row['tanggal']);
                                        if (empty($row['file'])) {
                                            $image = '';
                                            $required = 'required';
                                            $ket = '<br>*Kosongkan jika tidak merubah gambar';
                                        } else {
                                            $image = '<div class="col-sm-4 mb-2">
                                            <img src="' . $url . 'assets/images/berita/thumb_' . $row['file'] . '" class="img-thumbnail">
                                            <div class="form-text text-muted"><a href="#" id="del" data-id="' . $row['id'] . '" data-file="' . $row['file'] . '" data-nama="' . $row['judul'] . '" data-act="image"><i class="ph-trash me-1"></i>Hapus Gambar</a></div>
                                            </div>';
                                            $required = '';
                                            $ket = '<br>*Kosongkan jika tidak merubah gambar';
                                        }
                                    ...
                                    <div class="col-sm-12 col-lg-12">
                                        ...
                                        <div class="revdiv">
                                            ...
                                            <div class="col-sm-6 mb-2">
                                                ...
                                                <div class="form-text text-muted">*Accepted formats: png, jpg. Max file size 1Mb<?= $ket; ?></div>
                                            </div>
                                        </div>
...
<script>
    ...
    const image_upload_handler_callback = (blobInfo, progress) => new Promise((resolve, reject) => {
        ...
        xhr.open('POST', '<?= $url2; ?>proses/upload/berita');
    ...
    tinymce.init({
        ...
        toolbar: 'undo redo | styles | bold italic | alignleft aligncenter alignright alignjustify | outdent indent | numlist bullist | image | media | table | link | code',
        table_toolbar: 'tableprops tabledelete | tableinsertrowbefore tableinsertrowafter tabledeleterow | tableinsertcolbefore tableinsertcolafter tabledeletecol',

        // without images_upload_url set, Upload tab won't show up
        images_upload_url: '<?= $url2; ?>proses/upload/berita',
