...
cek_url($url2, $proses, $_GET['act'], 'prodi', 'id_prodi = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'prodi', 'id_prodi = ' . $_GET['id'] . '');
                                        echo '<input type="hidden" name="id_prodi" value="' . $row['id_prodi'] . '">';
                                    ...
                                    <div class="col-sm-12 col-lg-12">
                                        ...
                                        <div class="col-sm-6 mb-2">
                                            ...
                                            <input type="text" name="seo_prodi" class="form-control" value="<?= @$row['seo_prodi']; ?>" required>
                                            <small>URL jika prodi mempunyai alamat web sendiri</small>
                                        </div>
                                        <div class="col-sm-2 mb-2">
                                            <label class="form-label">Link Sendiri</label>
                                            <?= publish('link', @$row['link']); ?>
                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label">Isi Content</label>
                                            <textarea name="isi_halaman" id="myTextarea" class="form-control"><?= @$row['isi_halaman']; ?></textarea>
                                        </div>
