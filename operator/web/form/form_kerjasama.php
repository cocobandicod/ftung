...
cek_url($url2, $proses, $_GET['act'], 'kerja_sama', 'id_jurusan = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'kerja_sama', 'id_jurusan = ' . $_GET['id'] . '');
    ...
    $(document).on('submit', '#form', function(event) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                setTimeout(function() {
                    window.location = "<?= $url2 ?>kerjasama";
                }, 2000)
            },
