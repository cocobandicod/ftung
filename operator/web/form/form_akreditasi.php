                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'akreditasi', 'id_akreditasi = ' . $_GET['id'] . '');
                                        echo '<input type="hidden" name="id" value="' . $row['id_akreditasi'] . '">';
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text" name="peringkat" class="form-control" value="<?= @$row['peringkat']; ?>" required>
                                        </div>
                                        <div class="mb-2">
        ...
        $.ajax({
            ...
            success: function(data) {
                new Noty({
                    ...
                    setTimeout(function() {
                        window.location = "<?= $url2 ?>akreditasi";
                    }, 2000)
                );
            },
