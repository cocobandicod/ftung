...
cek_url($url2, $proses, $_GET['act'], 'struktur_organisasi', 'id_struktur = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <form method="post" id="form" class="form" enctype="multipart/form-data">
                                    <?php
                                    if ($_GET['act'] == 'edit') {
                                        $row = $proses->tampil_data_saja('*', 'struktur_organisasi', 'id_struktur = ' . $_GET['id'] . '');
                                        echo '<input type="hidden" name="id" value="' . $row['id_struktur'] . '">';
                                        ...
                                        if (empty($row['gambar'])) {
                                            ...
                                            $image = '<div class="col-sm-6 mb-2">
                                            <img src="' . $url . 'assets/images/dosen/' . $row['gambar'] . '" class="img-thumbnail">
                                            <div class="form-text text-muted"><a href="#" id="del" data-id="' . $row['id_struktur'] . '" data-file="' . $row['gambar'] . '" data-nama="' . $row['nama'] . '" data-act="image"><i class="ph-trash me-1"></i>Hapus Gambar</a></div>
                                            </div>';
                                            $required = '';
                                            $ket = '<br>*Kosongkan jika tidak merubah gambar';
                                        }
                                    ...
                                    <div class="col-sm-6 col-lg-6">
                                        ...
                                        <div class="revdiv">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <div class="form-text text-muted">*Accepted formats: png, jpg. Max file size 500Kb<?= $ket; ?></div>
                                            </div>
                                        </div>
...
<script>
    ...
    function validasiFile() {
        ...
        if (!ekstensiOk.exec(pathFile)) {
            ...
            if (file_size > 500000) {
                alert('Ukuran file harus kurang dari 500Kb');
                inputFile.value = '';
                return false;
            }
        }
