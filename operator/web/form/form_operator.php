...
cek_url($url2, $proses, $_GET['act'], 'operator', 'id_operator = "' . @$_GET['id'] . '"');
?>
<!DOCTYPE html>
                            ...
                            <div class="row">
                                ...
                                <form method="post" id="form" class="form">
                                    ...
                                    if ($_GET['act'] == 'edit') {
                                        ...
                                        echo '<input type="hidden" name="id_operator" value="' . $row['id_operator'] . '">';
