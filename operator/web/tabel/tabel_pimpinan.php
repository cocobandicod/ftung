...
foreach ($sql as $row) {
    if (!empty($row['gambar'])) {
        $link = $url . 'assets/images/dosen/' . $row['gambar'];
    ...
    <div class="d-inline-flex">
        <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end">
                <a href="' . $url2 . 'pimpinan/edit/' . $row['id_struktur'] . '" class="dropdown-item">
                    <i class="ph-note-pencil text-info me-2"></i>
                    Edit
                </a>
                <a href="#" id="del" data-id="' . $row['id_struktur'] . '" data-nama="' . $row['nama'] . '" data-act="del" class="dropdown-item">
