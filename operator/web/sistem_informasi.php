...
<body>
                ...
                <div class="content">
                    ...
                    <div class="card">
                        <div class="card-header d-sm-flex align-items-sm-center py-sm-0">
                            <h5 class="py-sm-2 my-sm-1"><?= str_replace('-', ' ', $_GET['judul']); ?></h5>
                            <div class="mt-2 mt-sm-0 ms-sm-auto">
                                <a href="<?= $url2; ?>sistem/informasi/add" class="btn btn-success btn-sm">
    ...
    <div id="modal_keyboard" class="modal fade modal_form" data-bs-keyboard="false">
...
<script>
    ...
    $(document).ready(function() {
        $('.modal_form').on('show.bs.modal', function(e) {
            ...
            $.ajax({
                type: 'post',
                url: '<?= $url2; ?>tampil/gambar',
                data: {
                    link: link
                },
                success: function(data) {
                    $('.fetched-data').html(data);
                    $('#myModalLabel').text('Gambar');
                },
            });
        });
    });
    ...
    $(document).ready(function() {
        datatable = $('.datatable-basic').DataTable({
            ...
            "ajax": {
                url: "<?= $url2; ?>tabel/sistem/informasi",
                type: "post"
            }
        });
    });
