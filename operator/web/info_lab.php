...
cek_url($url2, $proses, 'edit', 'jurusan', 'id_jurusan = "' . @$_SESSION['id_jurusan'] . '"');
                    ...
                    <div class="page-header-content d-lg-flex">
                        <div class="d-flex">
                            <h4 class="page-title mb-0">
                                Info Laboratorium <?= ucwords(str_replace('-', ' ', $p['nama_jurusan'])); ?>
                            </h4>
                        </div>
...
<script>
    ...
    $(document).ready(function() {
        datatable = $('.datatable-basic').DataTable({
            ...
            "ajax": {
                url: "<?= $url2; ?>tabel/profil/jurusan",
                type: "post",
                data: function(a) {
                    a.id_jurusan = <?= $p['id_jurusan']; ?>;
                    a.kat = 'Info-Laboratorium';
                },
            }
        });
    });
