...
<head>
    ...
    <title><?= $_GET['menu'] . ' | ' . $control['title']; ?></title>
    <meta name="description" content="<?= $_GET['menu'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= $_GET['menu'] . ' | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= $_GET['menu'] . ' | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= $_GET['menu'] . ' | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= $_GET['menu'] . ' | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= $_GET['menu'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <section class="blog-details pt-5 pb-5">
        <div class="container">
            <div class="col-lg-10 me-auto ms-auto row">
                <?php
                $sql = $proses->tampil_data_select('*', 'fasilitas', '1=1 ORDER BY id_jurusan ASC');
                foreach ($sql as $row) {
                ?>
