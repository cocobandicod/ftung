...
cek_url($url, $proses, 'edit', 'prestasi', 'id_jurusan = 0');
$p = $proses->tampil_data_saja('*', 'prestasi', '1=1 AND id_jurusan = 0');
...
<head>
    ...
    <title><?= 'Prestasi | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Prestasi | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Prestasi | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Prestasi | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Prestasi | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Prestasi | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Prestasi | ' . $control['deskripsi']; ?>">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover" style="font-size:13px;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $num = 1;
                                                    $sql2 = $proses->tampil_data_select('*', 'prestasi_prodi', 'id_prodi = "' . $row['id_prodi'] . '"');
