...
<head>
    ...
    <title><?= 'Informasi | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Informasi | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Informasi | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Informasi | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Informasi | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Informasi | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Informasi | ' . $control['deskripsi']; ?>">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="row">
                        ...
                        $no = $posisi + 1;
                        $sql = $proses->tampil_data_berita('*', 'berita', 'publish = "Yes" ORDER BY tanggal DESC', $posisi, $batas);
                        foreach ($sql as $row) {
                        ?>
                    ...
                    <div class="paginations mt-30 mb-30">
                        <ul>
                            <?php
                            $jmldata     = $proses->cek_count('berita', '1=1 AND publish = "Yes"');
