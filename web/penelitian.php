...
<head>
    ...
    <title><?= 'Penelitian | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Penelitian | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Penelitian | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Penelitian | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Penelitian | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Penelitian | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Penelitian | ' . $control['deskripsi']; ?>">
