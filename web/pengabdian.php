...
cek_url($url, $proses, 'edit', 'pengabdian', 'id_jurusan = 0');
$p = $proses->tampil_data_saja('*', 'pengabdian', '1=1 AND id_jurusan = 0');
...
<head>
    ...
    <title><?= 'Pengabdian | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Pengabdian | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Pengabdian | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Pengabdian | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Pengabdian | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Pengabdian | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Pengabdian | ' . $control['deskripsi']; ?>">
            ...
            <div class="row">
                <div class="col-lg-10 me-auto ms-auto">
                    <div class="accordion mt-5 mb-5" id="accordionExample">
                        <?php
                        $no = 1;
                        $sql = $proses->tampil_data_select('id_prodi,prodi', 'prodi', '1=1 ORDER BY id_prodi ASC');
                        foreach ($sql as $row) {
                        ?>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover" style="font-size:13px;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $num = 1;
                                                    $sql2 = $proses->tampil_data_select('*', 'pengabdian_prodi', 'id_prodi = "' . $row['id_prodi'] . '"');
