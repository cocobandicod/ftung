...
<head>
    ...
    <title><?= 'Pegawai | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Pegawai | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Pegawai | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Pegawai | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Pegawai | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Pegawai | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Pegawai | ' . $control['deskripsi']; ?>">
