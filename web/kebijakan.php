    ...
    <section class="uni-banner">
        <div class="container">
            <div class="uni-banner-text-area">
                <h1 class="mb-0"><?= str_replace('-', ' ', $_GET['menu']); ?></h1>
                <ul>
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql = $proses->tampil_data_select('*', 'kebijakan_peraturan', '1=1 AND ket = "' . $_GET['menu'] . '" ORDER BY id_kebijakan DESC');
                                foreach ($sql as $row) {
                                    if (empty($row['file'])) {
                                        $file = '';
                                    } else {
