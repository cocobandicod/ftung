...
<head>
    ...
    <title><?= 'Akreditasi | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Akreditasi | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Akreditasi | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Akreditasi | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Akreditasi | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Akreditasi | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Akreditasi | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                <?php
                                $no = 1;
                                $sql = $proses->tampil_data_select('*', 'akreditasi', '1=1 AND id_jurusan = ' . $p['id_jurusan'] . ' ORDER BY id_akreditasi ASC');
                                foreach ($sql as $row) {
                                    if (empty($row['file'])) {
                                        $file = '';
                                    } else {
