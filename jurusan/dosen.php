...
<head>
    ...
    <title><?= 'Dosen | ' . $pe['nama_jurusan'] . ' | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Dosen | ' . $pe['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Dosen | ' . $pe['nama_jurusan'] . ' | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Dosen | ' . $pe['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Dosen | ' . $pe['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Dosen | ' . $pe['nama_jurusan'] . ' | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Dosen | ' . $pe['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <section class="uni-banner">
        <div class="container">
            <div class="uni-banner-text-area">
                <h1 class="mb-0">Tenaga Pendidik</h1>
                <ul>
        ...
        <div class="container">
            <div class="col-lg-11 me-auto ms-auto">
                <div class="default-section-title row">
                    ...
                    $no = $posisi + 1;
                    $sql = $proses->tampil_data_berita('*', 'data_dosen', '1=1 AND id_jurusan = ' . $pe['id_jurusan'] . ' ORDER BY id_dosen ASC', $posisi, $batas);
                    foreach ($sql as $row) {
                        if ($row['id_sinta'] == NULL) {
                            ...
                            $link = $url . 'jurusan/' . $pe['seo'] . '/dosen/' . $row['nidn'];
                        }
                ...
                <div class="paginations mt-30 mb-30">
                    <ul>
                        <?php
                        $jmldata     = $proses->cek_count('data_dosen', '1=1 AND id_jurusan = ' . $pe['id_jurusan'] . ' ORDER BY id_dosen ASC');
                        $jmlhalaman  = $p->jumlahHalaman($jmldata, $batas);
                        $linkHalaman = $p->navHalaman(@$_GET['hal'], $jmlhalaman, $url . 'jurusan/' . $pe['seo'] . '/dosen');
                        echo $linkHalaman;
                        ?>
                    </ul>
                </div>
