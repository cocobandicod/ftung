...
$s = $proses->tampil_data_saja('*', 'penelitian', '1=1 AND id_jurusan = "' . @$p['id_jurusan'] . '"');
...
<head>
    ...
    <title><?= 'Penelitian | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Penelitian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Penelitian | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Penelitian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Penelitian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Penelitian | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Penelitian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered table-hover" style="font-size:13px;">
                                                ...
                                                <tbody>
                                                    <?php
                                                    $num = 1;
                                                    $sql2 = $proses->tampil_data_select('*', 'penelitian_prodi', 'id_prodi = "' . $row['id_prodi'] . '"');
