...
$s = $proses->tampil_data_saja('*', 'pengabdian', '1=1 AND id_jurusan = "' . @$p['id_jurusan'] . '"');
...
<head>
    ...
    <title><?= 'Pengabdian | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Pengabdian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Pengabdian | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Pengabdian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Pengabdian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Pengabdian | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Pengabdian | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
