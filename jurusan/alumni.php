...
<head>
    ...
    <title><?= 'Alumni | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?></title>
    <meta name="description" content="<?= 'Alumni | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
    ...
    <meta property="og:title" content="<?= 'Alumni | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>" />
    ...
    <meta property="og:description" content="<?= 'Alumni | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />
    <meta property="og:site_name" content="<?= 'Alumni | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>" />

    <!-- Twitter Card data -->
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="<?= 'Alumni | ' . $p['nama_jurusan'] . ' | ' . $control['title']; ?>">
    <meta name="twitter:description" content="<?= 'Alumni | ' . $p['nama_jurusan'] . ' | ' . $control['deskripsi']; ?>">
