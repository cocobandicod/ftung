<?php
function upload_1(){
				  define("UPLOAD_DIR", "../berkas_prodi/"); // LOKASI FILE	
				  ...
				  if (!in_array($fileType,$allowed)){
					  ...
					  window.location=('ajukan-akreditasi-prodi-$_GET[kode].html');</script>";
				  } else {
					  $tipe = 'lolos';
				  }
				  ...
				  if($tipe == 'lolos'){
					    ...
					    mysqli_query($con,"INSERT INTO ajukan_prodi_file VALUES ('$id_file','$_GET[kode]','$_POST[jenis_1]','$name','$nama_file','$date')");
...
function upload_2(){
				  ...
				  if($tipe == 'lolos'){
						...
						move_uploaded_file($myFile['tmp_name'], UPLOAD_DIR . $name); 
						$date = date('Y-m-d').' '.date("H:i:s");
					    mysqli_query($con,"INSERT INTO ajukan_prodi_file VALUES ('$id_file','$_GET[kode]','$_POST[jenis_2]','$name','$nama_file','$date')");
...
function upload_3(){
				  ...
				  if($tipe == 'lolos'){
						...
						move_uploaded_file($myFile['tmp_name'], UPLOAD_DIR . $name); 
						$date = date('Y-m-d').' '.date("H:i:s");
					    mysqli_query($con,"INSERT INTO ajukan_prodi_file VALUES ('$id_file','$_GET[kode]','$_POST[jenis_3]','$name','$nama_file','$date')");
...
function upload_4(){
				  ...
				  if($tipe == 'lolos'){
						...
						move_uploaded_file($myFile['tmp_name'], UPLOAD_DIR . $name); 
						$date = date('Y-m-d').' '.date("H:i:s");
					    mysqli_query($con,"INSERT INTO ajukan_prodi_file VALUES ('$id_file','$_GET[kode]','$_POST[jenis_4]','$name','$nama_file','$date')");
...
function upload_5(){
				  ...
				  if($tipe == 'lolos'){
						...
						move_uploaded_file($myFile['tmp_name'], UPLOAD_DIR . $name); 
						$date = date('Y-m-d').' '.date("H:i:s");
					    mysqli_query($con,"INSERT INTO ajukan_prodi_file VALUES ('$id_file','$_GET[kode]','$_POST[jenis_5]','$name','$nama_file','$date')");
...
function upload_6(){
				  ...
				  if($tipe == 'lolos'){
						...
						move_uploaded_file($myFile['tmp_name'], UPLOAD_DIR . $name); 
						$date = date('Y-m-d').' '.date("H:i:s");
					    mysqli_query($con,"INSERT INTO ajukan_prodi_file VALUES ('$id_file','$_GET[kode]','$_POST[jenis_6]','$name','$nama_file','$date')");
